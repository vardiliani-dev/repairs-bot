...
async def handle_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if update.message.document:
            ...
            await update.message.reply_text("Надішліть PDF файл або фото рахунку.")
            return

        # Зберігаємо file_id для пересилання бухгалтеру
        if update.message.document:
        ...
        data = await recognize_document(bytes(content), mime, is_pdf)
        ...
        await update.message.reply_text(
            "❗️ AI не зміг розпізнати документ автоматично.\n\n"
            "Введіть дані вручну:\n"
